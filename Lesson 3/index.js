...
for(let i = 0; i < 10; i++) {
    document.write(`<div>This is text</div>`);
}
...
for(let i = 0; i < 10; i++) {
    document.write(`<div>This is text with index ${i}</div>`);
}
...
let j = 0;
while(j < 20) {
    document.write(`<h1>This is text with index ${j}</h1>`);
    j++;
}
...
for(let k = 0; k < listOfItems.length; k++) {
    document.write(`<ul><li>${listOfItems[k]}</li></ul>`);
}
